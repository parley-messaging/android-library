...
public abstract class MessageViewHolder extends ParleyBaseViewHolder {
    ...
    private void applyBaseStyle() {
        ...
        balloonView.setMetaBackground(StyleUtil.getColorStateList(ta, R.styleable.ParleyMessageBase_parley_meta_background_color));
        balloonView.setMetaBackgroundCornerRadius(StyleUtil.getDimension(ta, R.styleable.ParleyMessageBase_parley_meta_background_corner_radius));
        ta.recycle();
    }
